...
The code is available via `openimg/node` and `openimg-node`. If you want to use solely the server code:
...
The configuration object accepts the following options:
