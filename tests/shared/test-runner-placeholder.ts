...
export function runPlaceholderTests(config: PlaceholderConfig) {
  ...
  test(`it returns a data URL when calling the ${type} placeholder fn with stream`, async () => {
  ...
  test(`it returns a data URL when calling the ${type} placeholder fn with buffer`, async () => {
